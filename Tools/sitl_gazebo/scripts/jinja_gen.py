...
if __name__ == "__main__":
    ...
    parser.add_argument('--qgc_udp_port', default=14550, help="Test changing the qgc port")
    ...
    parser.add_argument('--ros_namespace', default="iris_0", help="Namespace to use for ROS topics")
